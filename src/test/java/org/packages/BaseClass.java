...
public class BaseClass {
	static WebDriver driver;
		...
		/*
		 * BaseClasses is the main class which will take care of browser setup ,
		 * reusable methods like take screenshot windows handling . Using base class
		 * avoiding code duplication
		 */

		// Reusable Methods
		public static void browserLanuch1() {
	...
	public static void enterUrl(String url) {
		...
		public static  void maxmizeWindow1() {
			driver.manage().window().maximize();
		}


		// 3,Send the values
		public void sendValues(WebElement element, String i) {
			element.sendKeys(i);
		}
		...
		public String getElementTextbygteAttribute(WebElement element) {
		...
		// 30, Send the values by ja
		public void elementgetvaleByJs(WebElement element) {

			JavascriptExecutor executor = (JavascriptExecutor) driver;
			executor.executeScript("arguments[0].getAttribute('vale')", element);
		}

		// 31, Send the values by ja
		...
		// 36, Handling the alert by accep()
		...
		// 38, Handling Alert by SendKeys and accep()
		...
		public String getCellValue(String sheetName, int rowNumber, int cellnum) throws IOException {
			...
			File file = new File("C:\\Users\\ELCOT\\eclipse-workspace\\NewProjectpackage\\Excel\\Adactin.xlsx");
		...
		public void updateCellValue(String sheetName, int rownum, int cellnum, String oldValue, String newvalue)
				throws IOException {
			File file = new File("C:\\Users\\Bharath Kumar\\eclipse-workspace\\DataDriven\\Excel\\OmrSignup.xlsx");
		...
		public void updateCellValue(String sheetName, int rownum, int cellnum, String newvalue) throws IOException {
			File file = new File("C:\\Users\\Bharath Kumar\\eclipse-workspace\\DataDriven\\Excel\\CreateFile.xlsx");
		...
		// 44, Applying Inplicity waits
		public void implicityWit(int seconds) {
			driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(seconds));
		}

		// 45, Revers the String Values
		...
		// 57, Swirtch to the frame By Index
		public void switchbyIndex(int index) {
			driver.switchTo().frame(index);
		}

		// 58, Swirtch to the frame By Name
		public void switchbyName(String nameOrId) {
			driver.switchTo().frame(nameOrId);
		}

		// 59, Swirtch to the frame By Webelement
		public void switchbyWebElement(WebElement frameElement) {
			driver.switchTo().frame(frameElement);
		}

		// 60, Swirtch to the ParenFrame
		public void switchToParentFrame() {
			driver.switchTo().parentFrame();
		}
		// 61, Swirtch to the defaultFrame
